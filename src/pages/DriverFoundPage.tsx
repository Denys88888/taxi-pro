    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-0 left-0 right-0 z-floating safe-area-top">
        <div className="mx-4 mt-4 flex items-center justify-between">
          ...
          >
            <span className="text-primary text-sm font-semibold">Водитель назначен</span>
          </motion.div>
          <motion.button
      ...
      >
        <div className="bg-primary/90 backdrop-blur-xl px-5 py-2 rounded-full shadow-glow">
          <span className="text-white font-bold text-sm">{eta > 0 ? `${eta} мин` : 'Прибыл'}</span>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="px-4 pb-8 space-y-4">
          {cancelConfirm && (
            ...
            >
              <p className="text-error text-sm font-medium">Нажмите отмену еще раз для подтверждения</p>
            </motion.div>
          )}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="text-text-tertiary text-xs">({driver.trips.toLocaleString()} поездок)</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <span className="text-text-primary text-sm font-medium">Позвонить</span>
            </motion.button>
            <motion.button
              className="flex-1 h-12 bg-bg-surface rounded-piride-lg flex items-center justify-center gap-2 border border-white/5"
              whileTap={{ scale: 0.95 }}
            >
              ...
              <span className="text-text-primary text-sm font-medium">Чат</span>
            </motion.button>
          </div>
