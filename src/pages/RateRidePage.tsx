...
const POSITIVE_TAGS = [
  { key: 'greatDriver', label: 'Отличный водитель' },
  { key: 'cleanCar', label: 'Чистый автомобиль' },
  { key: 'onTime', label: 'Вовремя' },
  { key: 'friendly', label: 'Дружелюбный' },
  { key: 'safeDriving', label: 'Безопасное вождение' },
];

const NEGATIVE_TAGS = [
  { key: 'lateArrival', label: 'Опоздание' },
  { key: 'rudeBehavior', label: 'Грубое поведение' },
  { key: 'dirtyCar', label: 'Грязный автомобиль' },
  { key: 'unsafeDriving', label: 'Небезопасное вождение' },
  { key: 'wrongRoute', label: 'Неправильный маршрут' },
];
